...
import codersabordo from "../assets/images/codersabordo.jpeg"
        ...
        <>
            {projects.map((project, index)=>(
                <div key={index} >
                    ...
                    >
                        <div className="img">
                            <img src={require("src/assets/images/"+project.image)}></img>
                        </div>
                        <p>{project.description}</p>
                        <div>
                            {project.url && project.url != "" ? (<>
                                <Link to={project.url} target="_blank" rel="noopener">{project.type == "art" ? "Detail" : "Deployment"}</Link>
                            </>) : (<></>)}
                            {project.repository && project.repository != "" ? (<>
                                <Link to={project.repository} target="_blank" rel="noopener">Repository</Link>
                            </>) : (<></>)}
                        </div>
                    </div>
                </div>
